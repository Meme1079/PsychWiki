/* var haxeText:FlxText = new FlxText(0, 0, 0, 'This is a text in haxe!', 20, false);
haxeText.cameras = [game.camHUD];
haxeText.font    = Paths.font("vcr.ttf");
game.add(haxeText);

var haxeSprite:FlxSprite = new FlxSprite(0, 100);
haxeSprite.loadGraphic('assets/images/num0.png');
haxeSprite.cameras = [game.camHUD];
game.add(haxeSprite); */
